...
<?php
    ...
    //$aff_id = $session->set( 'dpt_affiliateId', $_GET['aff_id'] );
        $aff_id = $_GET['aff_id'];
...
<link rel="stylesheet" href="//code.jquery.com/ui/1.12.1/themes/base/jquery-ui.css">
	<form action="" id="hedonism" method="post" >
	    <div class="row" >
        ...
        <div class="row" style=""> 
			<div style="" >
				<button type="button" id="btn-submit-reservations" form-id="hidden-beach" class="btn-flat" >Submit<span></span></button> 
			</div>
        </div>
	</form>
